...
class ShuffleManager(private val repository: Repository) {
    ...
    enum class ShuffleMode(val titleRes: Int, val descriptionRes: Int) {
        PureRandom(R.string.shuffle_mode_pure_random, R.string.shuffle_mode_pure_random_description),
        MostPlayed(R.string.shuffle_mode_most_played, R.string.shuffle_mode_most_played_description),
        MostPlayedArtists(R.string.shuffle_mode_most_played_artists, R.string.shuffle_mode_most_played_artists_description),
        MostPlayedAlbums(R.string.shuffle_mode_most_played_albums, R.string.shuffle_mode_most_played_albums_description),
        FavoriteSongs(R.string.shuffle_mode_favorite_songs, R.string.shuffle_mode_favorite_songs_description),
        ForgottenSongs(R.string.shuffle_mode_forgotten_songs, R.string.shuffle_mode_forgotten_songs_description),
        RecentlyAdded(R.string.shuffle_mode_recently_added, R.string.shuffle_mode_recently_added_description),
        Combined(R.string.shuffle_mode_combined, R.string.shuffle_mode_combined_description)
    }
